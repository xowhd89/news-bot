...
- 아래 ===DETAILS=== 에 선정된 모든 뉴스의 맥락을 다 담아내되, 길고 지루한 줄글이 되지 않도록 **3~4개의 핵심 테마로 묶어 개조식(Bullet point)으로 요약**하세요.
- 각 테마는 글머리 기호(- 또는 *)를 사용하여, 핵심만 명료하고 임팩트 있게 짚어주는 임원용 브리핑 스타일로 작성하세요.
